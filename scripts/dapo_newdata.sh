...
# ---------- Debug ----------
# 正式训练关闭 frame-path debug，避免刷屏和 I/O 压力
...
EXP_NAME="qwen3vl8b_newdata_frames32_pure_dapo_run1_step115"
...
python -m verl.trainer.main \
  ...
  algorithm.loss_mode=grpo_on_policy \
  ...
  algorithm.teacher_reweight_enabled=false \
