...
export WANDB_NAME="qwen3vl8b_perceptiontest_sdpo_logit_fullvocab_successrollout_a800x4_4"
export WANDB_MODE="online"

# ---------- SDPO debug dump ----------
export SDPO_DEBUG_DUMP=1
export SDPO_DEBUG_DUMP_PATH="/ssd5/xhou/outputs/sdpo_debug_fullvocab_successrollout_a800x4_4.jsonl"
...
python -m verl.trainer.main \
  ...
  trainer.experiment_name=qwen3vl8b_perceptiontest_sdpo_logit_fullvocab_successrollout_a800x4_4 \
