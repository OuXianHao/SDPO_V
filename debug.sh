...
export WANDB_NAME='qwen3vl8b_perceptiontest_sdpo_logit_fullvocab_successrollout_2gpu_smoketest'
...
export SDPO_DEBUG_DUMP_PATH="/ssd5/xhou/outputs/sdpo_debug_fullvocab_successrollout_2gpu_smoketest.jsonl"
export SDPO_DEBUG_MAX_SAMPLES=80
...
python -m verl.trainer.main \
  ...
  trainer.experiment_name=qwen3vl8b_perceptiontest_sdpo_logit_fullvocab_successrollout_2gpu_smoketest \
